...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Always start at top on route change
  useEffect(() => {
    ...
    <div className="min-h-screen flex flex-col bg-black selection:bg-yellow-500/30 selection:text-yellow-200 overflow-x-hidden">
      ...
      <nav
        className={`fixed w-full z-50 transition-all duration-500 ${
          scrolled || isMenuOpen
            ? 'bg-black/95 border-b border-zinc-900 py-3 md:py-4'
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          <div className="lg:col-span-1">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed mb-8 font-light italic">
              "A Home for Storytellers." The premiere film festival of St.
          ...
          <div>
            <h4 className="text-[10px] font-black tracking-[0.3em] text-zinc-100 uppercase mb-6 opacity-50">
              CONNECT
            </h4>
            <ul className="space-y-3 text-sm text-zinc-500 font-light">
              <li>
                <a
                  ...
                  className="hover:text-white transition-all duration-300 break-all block"
                >
                  nirvahana@stpetershyd.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+918539995558"
