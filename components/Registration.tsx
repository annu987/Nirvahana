  ...
  return (
    <section id="register" className="py-20 md:py-32 bg-black px-6">
      <div className="max-w-5xl mx-auto text-center md:text-left">
        <span className="text-yellow-500 text-[10px] font-black tracking-[0.4em] uppercase mb-4 md:mb-6 block">
          JOIN THE CARNIVAL
        </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div>
              <h4 className="text-xl md:text-2xl font-serif-cinematic font-black text-white mb-2">
                Registrations Open (22 Feb – 15 Mar)
              </h4>
              <p className="text-zinc-500 text-sm md:text-base leading-relaxed">
                Registrations for all Nirvahana competitions and workshops are now live on <strong>Unstop</strong>.
                Click below to register and participate in your preferred events.
              </p>
            </div>
          </div>
